...
<div class="form-group row mt-2 mb-2">
    {{ Form::label('inputEnterYourName', 'Enter Brand Name', ['class' => 'col-sm-3 col-form-label']) }}
    <div class="col-sm-9">
        {{ Form::text('brand_name', null, ['class' => 'form-control', 'id' => 'inputEnterYourName', 'placeholder' => 'Enter Your Name']) }}
    </div>
</div>
