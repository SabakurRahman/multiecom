    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="{{route('brand.create')}}"><i class="bx bx-right-arrow-alt"></i>Brand Create</a>
                </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="{{route('category.create')}}"><i class="bx bx-right-arrow-alt"></i>Category Create</a>
                </li>
